...
-- Users
INSERT INTO users (id, username, full_name, role, password, active, station_id)
VALUES
  ('5c2ec8f9-6a3f-4d2a-b9ee-39f11f7ec8b1', 'operator',   'Tendai Moyo',   'OPERATOR',   crypt('1234', gen_salt('bf', 10)), TRUE, 'ST01'),
  ('09b5ccf3-4195-46ac-8f84-2ac7c6f7da8a', 'operator2',  'Farai Dube',    'OPERATOR',   crypt('1234', gen_salt('bf', 10)), TRUE, 'ST02'),
  ('4c6e1372-12b5-4f4c-8a52-e5ee7802f4c2', 'supervisor', 'Rudo Chikwanda','SUPERVISOR', crypt('1234', gen_salt('bf', 10)), TRUE, 'ST01'),
  ('f2dd7026-8557-42c2-b4a8-934a8f8f4c41', 'admin',      'System Admin',  'ADMIN',      crypt('1234', gen_salt('bf', 10)), TRUE, NULL)
